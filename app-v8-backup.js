...
function initAssistant() {
  ...
  if (!feed) return;
  // Just render - welcome state is now visual, not a message
  renderAssistantChat();
}
...
function renderAssistantChat() {
  ...
  // Show/hide welcome state and quick chips based on messages
  ...
  S.assistantMessages.forEach(m => {
    ...
    html += '<div class="ast-avatar">' + avatar + '</div>';
...
// Send a prompt from quick suggestion chips
